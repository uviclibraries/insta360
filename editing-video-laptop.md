...
2. Open Insta360 Studio, and drag the video file to the left hand side where it says drag and drop footage here. <img src="images/insta-video-editing-01.png" style="float:right;width:180px;height:180px;">>

3. In the view window (bottom left hand side of video screen), you can play and preview the file using different angles (tiny planet, crystal ball, natural view, default and flat). <img src="images/insta-video-editing-02.png" style="float:right;width:180px;height:180px;">
